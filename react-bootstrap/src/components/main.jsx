          ...
          <div className="row">
              ...
              <div className="col-md-4 mx-auto">
                  <div className="card mt-5 position-relative">
                      <img src="/assets/Rectangle%205.svg" className="card-img-top mx-auto" alt="..."/>
                  ...
                  <div className="card mt-5 position-relative">
                      <img src="/assets/Rectangle%206.svg" className="card-img-top mx-auto" alt="..."
                      />
                      <img src="/assets/CheckCircle.svg"
                           className="position-absolute top-50 start-50 translate-middle" alt="Check"
                           style={{width: '110px', height: '110px'}}/>
                      <img src="/assets/image%205.svg" className="position-absolute bottom-0 start-0" alt="Image"
                           style={{width: '120px', height: '120px'}}/>
